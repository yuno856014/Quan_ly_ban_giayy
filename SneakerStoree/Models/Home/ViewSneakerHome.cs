...
namespace SneakerStoree.Models.Home
{
    public class ViewSneakerHome
    {
        ...
        public Entities.TradeMark TradeMark { get; set; }
        public ICollection<Entities.Sneaker> Sneakers { get; set; }
